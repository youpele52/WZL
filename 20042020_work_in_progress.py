# -*- coding: utf-8 -*-
"""
Created on Tue Apr 21 20:24:48 2020
...
datasets = "D:/WZL/12032020/dataset"

data_dir = datasets 

work_dir = "C:/Users/Youpele/Desktop"

data_dir = "/Volumes/Youpele_HD/WZL/12032020/dataset"     
        
a = Filter.create_model(data_dir = data_dir, num_epochs = 1, 
                           work_dir =work_dir)
...
model_path = "/Volumes/Youpele_HD/WZL/20042020/GoodVsCorruptModel.pth"


b = Filter.multi_pred_signal(model_path, containing_folder, image_folder)


filepathed___ = "/Volumes/Youpele_HD/WZL/12032020/AKS-19-KS-Stempel-hinten/"


c = Filter.corrupt_punch_check2(filepathed___)
...
b = a.good_vs_corrupt(data_dir = datasets)
        
        

        
        
folder = '/Volumes/Youpele_HD/WZL/12032020/dataset/val/good_data'         
...
ImageFolder_afterwards = os.listdir(folder)
